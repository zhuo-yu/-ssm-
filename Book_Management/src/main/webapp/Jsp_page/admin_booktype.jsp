                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <!---在此插入信息-->
                             <%
                             ArrayList<BookType> booktypedata = (ArrayList<BookType>) session.getAttribute("booktypedata");
                                  for (BookType bean : booktypedata){
                              %>
								<tbody>
...
<button type="button" class="btn btn-danger btn-xs" onclick="deletebook(<%= bean.getTid() %>)">删除</button>
    ...
    function deletebook(tid) {
    	con=confirm("是否删除?"); 
    	if(con==true){
    		location.href = "../Type/DeleteBookType?tid="+tid;
    	}
    }
    </script>
                                     ...
                                     <!-------------------------------------------------------------->  
                                        ...
                                        <!-- 修改模态框（Modal） -->
                               <form class="form-horizontal" method="post" action="../Type/UpdateBookType">   <!--保证样式水平不混乱-->
     ...
     <!--------------------------------------添加的模糊框------------------------>  
                                 <form class="form-horizontal" method="post" action="../Type/AddBookType">   <!--保证样式水平不混乱-->
                                        <!-- 模态框（Modal） -->

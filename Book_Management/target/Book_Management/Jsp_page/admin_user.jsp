                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <!---在此插入信息-->
                             <%
                             ArrayList<Admin> AllAdmindata = (ArrayList<Admin>) session.getAttribute("AllAdmindata");
                             for (Admin bean : AllAdmindata){
  %>                 
								<tbody>
...
<button type="button" class="btn btn-danger btn-xs" onclick="deletebook(<%= bean.getAid() %>)">删除</button>
    ...
    function deletebook(aid) {
    	con=confirm("是否删除?"); 
    	if(con==true){
    		location.href = "../Admin/DeleteReader?aid="+aid;
    	}
    }
    </script>
                                     ...
                                     <!-------------------------------------------------------------->  
                                        ...
                                        <!-- 修改模态框（Modal） -->
                               <form class="form-horizontal" method="post" action="../Admin/UpdateReader">   <!--保证样式水平不混乱-->
     ...
     <!--------------------------------------添加的模糊框------------------------>  
                                 <form class="form-horizontal" method="post" action="../Admin/AddReader">   <!--保证样式水平不混乱-->
                                        <!-- 模态框（Modal） -->

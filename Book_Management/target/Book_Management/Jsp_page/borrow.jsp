    ...
    <div class="row">
        ...
        <div class="col-md-2 bootstrap-admin-col-left">
            <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
               <li>
                    <a href="../Book/BookManage"><i class="glyphicon glyphicon-chevron-right"></i> 图书查询</a>
                </li>
	            <li>
	                 <a href="../History/ReaderSelectBorrow"><i class="glyphicon glyphicon-chevron-right"></i> 借阅信息</a>
	                </li>
	                <li>
	                    <a href="../History/GetBorrowHistory"><i class="glyphicon glyphicon-chevron-right"></i> 借阅历史</a>
	                </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <%
                             ArrayList<BookHistory> readerhistorydata = (ArrayList<BookHistory>) session.getAttribute("readerhistorydata");
                              for (BookHistory bean : readerhistorydata){
                              %>
                            	<tbody>
	                         	   	<td><%= bean.getCard() %></td>
...
<button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="haibook(<%= bean.getHid() %>)">还书</button>
    ...
    function haibook(hid) {
    	con=confirm("是否还书?"); 
    	if(con==true){
    		location.href = "../History/UpdateBorrow?tip=0&hid="+hid;  //tip区分管理员与读者身份,1为管理员,0为读者
    	}
    }
    </script>
        </div>

...
<%@ page import="Zy.Pojo.Book" %>
<%@ page import="Zy.Pojo.BookType" %>
<%@ page import="Zy.Dao.BookDao" %>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                <form class="form-horizontal" action="../Book/SelectBook" method="post">
...
<button type="button" class="btn btn-danger btn-xs" onclick="deletebook(<%= bean.getBid() %>)">删除</button>
    ...
    function deletebook(bid) {
    	con=confirm("是否删除?"); 
    	if(con==true){
    		location.href = "../Book/DeleteBook?bid="+bid;
    	}
    }
    </script>
                                     ...
                                     <!-------------------------------------------------------------->  
                                        ...
                                        <!-- 修改模态框（Modal） -->
                               <form class="form-horizontal" method="post" action="../Book/UpdateBook">   <!--保证样式水平不混乱-->
										...
										<div class="form-group">	
											...
											<div class="col-sm-7">
												 <select class="form-control" id="updateBookType" name="type" onPropertyChange="showValue(this.value)">
                                                     ...
                                                     <%
                    ArrayList<BookType> data = (ArrayList<BookType>) session.getAttribute("Booktypedata");
                      for (BookType bean : data){
  %>                 <option value="<%= bean.getName() %>"><%= bean.getName() %></option>                        <%} %>                                        
     ...
     <!--------------------------------------添加的模糊框------------------------>  
                                 <form class="form-horizontal" method="post" action="../Book/AddBook">   <!--保证样式水平不混乱-->
                                        <!-- 模态框（Modal） -->
